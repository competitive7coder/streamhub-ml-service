...
# We use CountVectorizer to turn text genres into a matrix of numbers
...
# This creates a big matrix where you can look up how similar movie A is to movie B
...
def get_recommendations():
    ...
    try:
        ...
        # This prevents the 'KeyError' crash if a movie is in the watchlist but not in movies.csv
    ...
    # This (sim_scores) is now the user's "taste profile"
    # We are averaging the scores of all movies they like
    ...
    # We compare lists of integers for safety
...
if __name__ == '__main__':
    # Run on port 5001 (or any port that's not your Node.js port)
